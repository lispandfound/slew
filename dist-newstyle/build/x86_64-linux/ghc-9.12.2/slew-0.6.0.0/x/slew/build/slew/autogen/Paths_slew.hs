...
-- at runtime using the environment variable slew_bindir.
...
-- environment variable slew_libdir.
...
-- using the environment variable slew_dynlibdir.
...
-- runtime using the environment variable slew_datadir.
...
-- using the environment variable slew_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33/slew-0.6.0.0-inplace-slew"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.12.2-9b33/slew-0.6.0.0"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.12.2-9b33/slew-0.6.0.0"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "slew_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "slew_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "slew_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "slew_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "slew_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "slew_sysconfdir") (\_ -> return sysconfdir)
